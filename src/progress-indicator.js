...
blimpkit.directive('bkProgressIndicator', (classNames) => ({
  ...
  link: (scope, _element, attrs) => {
    if (!Object.prototype.hasOwnProperty.call(attrs, 'ariaLabel')) console.error('bk-progress-indicator error: You should provide a description using the "aria-label" attribute');
    scope.getClasses = () =>
      classNames('fd-progress-indicator', {
