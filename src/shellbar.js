 ...
 */
blimpkit
  .directive('bkShellbar', (classNames) => ({
    restrict: 'E',
    transclude: true,
    replace: true,
    scope: {
  ...
  .directive('bkShellbarAction', (classNames) => ({
    ...
    link: (scope) => {
      scope.getClasses = () =>
        classNames('fd-shellbar__action', {
  ...
  .directive('bkShellbarButton', () => ({
    ...
    link: (_scope, element, attrs) => {
      ...
      if (Object.prototype.hasOwnProperty.call(attrs, 'isMenu') && attrs.isMenu === 'true') element.addClass('fd-shellbar__button--menu');
    },
  }))
