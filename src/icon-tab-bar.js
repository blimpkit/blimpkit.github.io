 ...
 */
blimpkit
  .directive('bkIconTabBar', function (classNames, $injector, $timeout) {
    ...
    return {
      ...
      controller: [
        ...
        function ($scope) {
          ...
          $scope.getClasses = () =>
            classNames('fd-icon-tab-bar', 'bk-icon-tab-bar', {
          ...
          this.onTabClose = function (tabId) {
            ...
            if (tabId === $scope.selectedTabId) {
              if ($scope.lastSelectedTabId) nextSelectedTabId = $scope.lastSelectedTabId;
  ...
  .directive('bkTabsOverflowable', ($timeout) => ({
    ...
    link: function (scope, element, _attr, tabBarCtrl) {
      ...
      scope.updateTabsVisibility = (containerWidth = -1) => {
        ...
        if (containerWidth === -1) containerWidth = tabsListEl.width();
  ...
  .directive('bkIconTabBarOverflowItem', (classNames, ButtonStates) => ({
    ...
    link: {
      pre: function (scope) {
        scope.getClasses = () =>
          classNames('fd-list__item', 'fd-list__item--link', 'fd-icon-tab-bar__list-item', {
