 ...
 */
blimpkit
  .directive('bkNotification', (classNames) => ({
    restrict: 'E',
    transclude: true,
    replace: true,
    scope: {
  ...
  .directive('bkNotificationContent', () => ({
    restrict: 'A',
    link: (_scope, element) => {
      element.addClass('fd-notification__content');
    },
  }))
  .directive('bkNotificationHeader', () => ({
    restrict: 'A',
    link: (_scope, element) => {
      element.addClass('fd-notification__header');
    },
  }))
  ...
  .directive('bkNotificationParagraph', () => ({
    restrict: 'A',
    link: (_scope, element) => {
      element.addClass('fd-notification__paragraph');
    },
  }))
  .directive('bkNotificationFooter', () => ({
    restrict: 'A',
    link: (_scope, element) => {
      element.addClass('fd-notification__footer');
    },
  }))
  .directive('bkNotificationFooterContent', () => ({
    restrict: 'A',
    link: (_scope, element) => {
      element.addClass('fd-notification__footer-content');
    },
  }))
  .directive('bkNotificationSeparator', () => ({
    restrict: 'A',
    link: (_scope, element) => {
      element.addClass('fd-notification__separator');
    },
  }))
  .directive('bkNotificationActions', () => ({
    restrict: 'A',
    link: (_scope, element) => {
      element.addClass('fd-notification__actions');
    },
  }));
