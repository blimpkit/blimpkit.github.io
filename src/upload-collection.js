 ...
 */
blimpkit
  .directive('bkUploadCollection', (classNames, $injector) => {
    ...
    return {
      ...
      link: (scope) => {
        scope.getClassNames = () =>
          classNames('fd-list', 'fd-list--byline', 'fd-upload-collection', {
    ...
    controller: [
      ...
      function ($scope) {
        ...
        this.applyFilenameChange = function () {
          ...
          if ($scope.fileNameChanged) $scope.fileNameChanged({ fileName: $scope.fileName });
        };

        this.deleteItem = function () {
          if ($scope.deleteClicked) $scope.deleteClicked();
        };

        $scope.getClassNames = () =>
          classNames('fd-list__item', 'fd-upload-collection__item', {
