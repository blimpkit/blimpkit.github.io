...
blimpkit
            ...
            if (index >= 0) {
              ...
              if (nestingLevel > 1) {
                for (let i = index - 1; i >= 0; i--) {
                  ...
                  if (row.groupRow && row.nestingLevel < nestingLevel) return i;
                }
              }
            }
  ...
  .directive('bkTableIcon', (classNames) => ({
    ...
    link: (scope) => {
      scope.getClasses = () =>
        classNames('fd-table__icon', scope.glyph, {
